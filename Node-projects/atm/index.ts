        ...
        inquirer
            ...
            .then((answers) => {
                ...
                const isUserAuthenticated =
                    userId === userData.userId.toString() && userPin === userData.userPin.toString();
...
const displayATMMenu = (): Promise<string> => {
    return new Promise((resolve) => {
        inquirer
            .prompt([
                {
...
const performBalanceInquiry = (): void => {
    console.log(chalk.blue(`Your balance is $${userData.balance}`));
};

const performWithdrawal = (): Promise<void> => {
...
const performDeposit = (): Promise<void> => {
    return new Promise(async (resolve) => {
...
const startATM = async (): Promise<void> => {
